...
function helminstalllonghorn
{
  ...
  helm repo update
  helm --kubeconfig=./local/admin.conf install longhorn longhorn/longhorn --namespace longhorn-system --create-namespace 
}
...
Log "\__Mounting longhorn volume on master nodes.."
...
Log "\__Installing longhorn via helm.."
helminstalllonghorn
